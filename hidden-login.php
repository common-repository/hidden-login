...
{
	wp_enqueue_style( 'hidden_login', WP_PLUGIN_URL . '/hidden-login/hidden-login.min.css');
}

//** Insert Javascript File **//
function hidden_login_js_file()
{
	wp_enqueue_script('hidden_login', WP_PLUGIN_URL . '/hidden-login/hidden-login.min.js', array('jquery'), '1.0', true);
}
